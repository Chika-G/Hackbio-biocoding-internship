#This information is organised in alphabetical order using the dictionary data structure
#Printing
print("Proline team 1")
Team_Proline1_Info = {
   "Member_1": {
    ...
    "Member_3": {     #Creating a dictionary 
        "Name": "Chika Onyedikachukwu",  
        "Slack Username": "Onyedikachukwu",
        "Email": " chikadika18@gmail.com",      #Key-value pairs
        "Hobby": "Reading",
        "Country": "Nigeria",
...
print(Team_Proline1_Info)   #Printing the dictionary 
#https://github.com/Chika-G/Hackbio-biocoding-internship/blob/main/README.md#hackbio-biocoding-internship
